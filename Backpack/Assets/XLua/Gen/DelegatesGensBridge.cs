...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp1(UnityEngine.EventSystems.BaseEventData p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(DragObj.LuaFuncWithPointerEventDataDelegate))
			{
			    return new DragObj.LuaFuncWithPointerEventDataDelegate(__Gen_Delegate_Imp1);
			}
